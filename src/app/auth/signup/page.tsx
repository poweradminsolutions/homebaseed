        ...
        <div className="w-full max-w-md">
          <div className="bg-white rounded-lg border border-border shadow-sm p-8 text-center">
            ...
            <p className="text-muted mb-6">
              ...
              link to verify your email and complete your signup.
            </p>
            ...
            <Link
              href="/auth/login"
              className="inline-block px-4 py-2 bg-primary text-white font-medium rounded-lg hover:bg-primary-dark transition-colors"
            >
              Back to Sign In
            </Link>
          </div>
      ...
      <div className="w-full max-w-md">
        <div className="bg-white rounded-lg border border-border shadow-sm p-8">
          ...
          <p className="text-muted mb-8">
            Join The Homeschool Source community
          </p>
