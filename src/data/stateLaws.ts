...
export const stateLaws: Record<string, StateLawData> = {
  ...
  florida: {
    ...
    slug: "florida",
    regulationLevel: "low",
    legalStatus: "Legal as a home education program with county notification",
    compulsoryAges: "6-16",
    noticeRequired: true,
    noticeDetails: "File a Notice of Intent with your county school superintendent within 30 days of starting. You do not need to register as a private school or with the state Department of Education.",
    ...
    recordKeeping: "Maintain a portfolio of educational records and materials; preserve records for two years",
    teacherQualifications: "No formal qualifications required for parents under the home education option; evaluator must be certified teacher",
    specialEdAccess: true,
    sportsAccess: false,
    diplomaIssuing: "Parents may issue diploma",
    umbrellasAllowed: true,
    keyStatutes: ["Fla. Stat. § 1002.41", "Fla. Stat. § 1002.01"],
    quickSummary: "Florida requires you to file a Notice of Intent with your county school superintendent (not the state). You do not need to create your own school. Annual evaluation is required via portfolio review, standardized test, or certified teacher evaluation.",
